...
from animals.views.animals_view import AnimalsFarmer, AnimalDetail, AnimalSearchByName, AnimalListSerializer
...
urlpatterns = [
    ...
    path('animals-list/', AnimalsFarmer.as_view(), name='animals-list'),
